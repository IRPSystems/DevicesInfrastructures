...
{
    public class DeviceFullData_MX180TP : DeviceFullData
    {

        public DeviceFullData_MX180TP(DeviceData deviceData) :
            base(deviceData)
        {
        }
        protected override string GetConnectionFileName()
        {
            return "MX180TPConnect.json";
        }
        protected override void ConstructCommunicator(LogLineListService logLineList)
        {
            DeviceCommunicator = new MX180TP_Communicator(logLineList);
        }
        ...
        protected override void ConstructConnectionViewModel(LogLineListService logLineList)
        {
            ...
            ConnectionViewModel = new TcpConncetViewModel(9221, 14323, 14320, "");
            ...
            (ConnectionViewModel as TcpConncetViewModel).EASearchIPEvent +=
                TcpConncetVM_MX180TPSearchIPEvent;
        }
        ...
        private void TcpConncetVM_MX180TPSearchIPEvent()
        {
            Task task = Task.Run(() =>
            {
                MX180TPSearchIP();
        ...
        protected override void InitRealCommunicator()
        {
            ...
            (DeviceCommunicator as MX180TP_Communicator).Init(
